  ...
  const renderServiceCard = (service: typeof services[0], index: number) => {
    ...
    return (
      <div
        ...
        className="relative group bg-[#FFFAF3] rounded-lg overflow-hidden hover:shadow-lg transition-all duration-300 border border-gray-200/60 flex-shrink-0 w-full flex flex-col"
        style={{ minHeight: '100%' }}
      >
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-6 md:mb-16">
          <h3 className="text-[11px] font-bold tracking-[0.2em] uppercase text-gray-600 mb-2 md:mb-4">
            OUR SERVICES
          </h3>
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-display font-normal text-black mb-4 md:mb-8">
