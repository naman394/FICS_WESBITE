...
import { getPodcastBySlug, getRelatedPodcasts } from '@/data/podcasts';
...
export default function PodcastDetailPage() {
  ...
  const relatedPodcasts = getRelatedPodcasts(podcast.id, 3);
              ...
              <div>
                ...
                <div className="space-y-4">
                  {relatedPodcasts.map(p => (
                    <Link href={`/podcasts/${p.slug}`} key={p.id} className="flex items-center gap-4 group hover:bg-white/5 p-3 rounded-xl transition-colors">
